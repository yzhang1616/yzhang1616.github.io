...
{\em Pattern Avoidance in $0$-$1$-fillings of Ferrers Shapes}, 2018, in preparation.
...
\begin{itemize}
  \item \href{https://yzhang1616.github.io/frp/frp.m}{frp.m}, a Mathematica package for generating full
    rook placements of a Ferrers board (shape), checking the number of
    sigma-avoiding full rook placements of a Ferrers board, 
     generating $0$-$1$-fillings of a Ferrers board, 
     and checking the number of $0$-$1$-fillings of a Ferrers board with weight $n$
    ...
    see the \href{https://yzhang1616.github.io/frp/frp.nb}{frp.nb} notebook. 
