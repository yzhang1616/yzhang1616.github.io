...
\section{Rational solutions of high-order algebraic ordinary differential equations} \label{SECT:Laurentsols}
...
AODEs having no rational general solution can still have several particular rational solutions.
The algorithms developed in \cite{HuangNgoWinkler2013} are not able to detect these solutions.
Therefore, it is necessary to develop new  algorithms for determining all rational solutions, including both general and particular solutions.
Our main purpose is to give a method for determining such solutions for high-order AODEs.
...
\begin{enumerate}
 ...
 An AODE satisfying this condition is called \emph{noncritical}. Then we prove that some common classes of low-order AODEs are noncritical.
 \item  For rational solutions, we determine a class of AODEs, which are called \emph{maximally comparable}, 
such that the possible poles of any rational solutions are recognizable from their coefficients.
 ...
 \item We develop an algorithm to compute all rational solutions of certain maximally comparable AODEs, 
...
This work is available in~\cite{VoZhang2019}.

\subsection{Future work}

\begin{enumerate}
 \item Design algorithms for computing rational solutions of systems of AODEs. 
\end{enumerate}

\section{Rational Solutions of First-Order Algebraic Ordinary Difference Equations} 
...
\begin{enumerate}
 \item We propose an algebraic geometric approach for studying rational solutions of first-order \AODEs. 
 We prove that if an {\AODE} admits a strong rational general solution then its corresponding algebraic curve is of genus zero. 
Thus, we can take use of parametric representations of rational curves to transform the original difference equation into an associated difference equation which is of simpler form. 
The latter difference equation has a special form and it  is called a \emph{separable difference equation}. 
We prove that there is a one-to-one corresponding between the strong rational general solutions of the given {\AODE} and those of the associated separable difference equation.

 \item  For an autonomous first-order \AODE, we give an upper bound for the degrees of its rational solutions, and thus derive a complete algorithm for 
...
This work is available in~\cite{VZ2019}.
...
\bibitem{HuangNgoWinkler2013}
Y.~Huang, L.~X.~C.~Ngo and F.~Winkler, 
\newblock {\em {Rational general solutions of higher order algebraic ODEs}}.  
\newblock {\em Journal of Systems Science and Complexity}, 26(2): 261-280, 2013.
